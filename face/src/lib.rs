...
\n")
    ...
    pub fn rot_r(&mut self) { self.set_rotation((self.rotate + 1).rem_euclid(4)); }
    pub fn rot_l(&mut self) { self.set_rotation((self.rotate - 1).rem_euclid(4)); }
    pub fn flip (&mut self) { self.set_rotation((self.rotate + 2).rem_euclid(4)); }
}
